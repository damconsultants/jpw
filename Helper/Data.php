...
class Data extends AbstractHelper
{
    ...
    public function getCheckBynder()
    {
        ...
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'jpw-check-bynder-license');
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-check-bynder-license', $jsonData);
    ...
    public function getDerivativesImage($bynder_auth)
    {
        ...
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'jpw-magento-derivatives');
        $this->_curl->setOption(CURLOPT_RETURNTRANSFER, true);
        $this->_curl->setOption(CURLOPT_TIMEOUT, 0);
        $this->_curl->setOption(CURLOPT_ENCODING, '');
        $this->_curl->setOption(CURLOPT_MAXREDIRS, 10);
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-magento-derivatives', $jsonData);
    ...
    public function getLicenceKey()
    {
        ...
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'jpw-get-license-key');
        $this->_curl->setOption(CURLOPT_RETURNTRANSFER, true);
        $this->_curl->setOption(CURLOPT_TIMEOUT, 0);
        $this->_curl->setOption(CURLOPT_ENCODING, '');
        $this->_curl->setOption(CURLOPT_MAXREDIRS, 10);
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-get-license-key', $jsonData);
    ...
    public function getBynderChangemetadataAssets($product_url, $url_data)
    {
        ...
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'jpw-change-metadata-magento');
        $this->_curl->setOption(CURLOPT_RETURNTRANSFER, true);
        $this->_curl->setOption(CURLOPT_TIMEOUT, 0);
        $this->_curl->setOption(CURLOPT_ENCODING, '');
        $this->_curl->setOption(CURLOPT_MAXREDIRS, 10);
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-change-metadata-magento', $jsonData);
    ...
    public function getBynderChangemetadataAssetsDoc($product_url, $url_data)
    {
        ...
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'jpw-change-metadata-magento-doc');
        $this->_curl->setOption(CURLOPT_RETURNTRANSFER, true);
        $this->_curl->setOption(CURLOPT_TIMEOUT, 0);
        $this->_curl->setOption(CURLOPT_ENCODING, '');
        $this->_curl->setOption(CURLOPT_MAXREDIRS, 10);
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-change-metadata-magento-doc', $jsonData);
    ...
    public function getBynderChangemetadataAssetsVideo($product_url, $url_data)
    {
        ...
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'jpw-change-metadata-magento-video');
        $this->_curl->setOption(CURLOPT_RETURNTRANSFER, true);
        $this->_curl->setOption(CURLOPT_TIMEOUT, 0);
        $this->_curl->setOption(CURLOPT_ENCODING, '');
        $this->_curl->setOption(CURLOPT_MAXREDIRS, 10);
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-change-metadata-magento-video', $jsonData);
    ...
    public function getBynderDataCmsPage($CMSPageURL, $url_data)
    {
        ...
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'jpw-change-metadata-magento-cms-page');
        $this->_curl->setOption(CURLOPT_RETURNTRANSFER, true);
        $this->_curl->setOption(CURLOPT_TIMEOUT, 0);
        $this->_curl->setOption(CURLOPT_ENCODING, '');
        $this->_curl->setOption(CURLOPT_MAXREDIRS, 10);
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-change-metadata-magento-cms-page', $jsonData);
    ...
    public function getBynderMetaProperites()
    {
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-get-bynder-meta-properites', $jsonData);
    ...
    public function getImageSyncWithProperties($sku_id, $property_id, $collection_data_value)
    {
        ...
        $jsonData = '{}';
        $fields = json_encode($fields);
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'jpw-bynder-skudetails-new');
        $this->_curl->setOption(CURLOPT_RETURNTRANSFER, true);
        $this->_curl->setOption(CURLOPT_TIMEOUT, 0);
        $this->_curl->setOption(CURLOPT_ENCODING, '');
        $this->_curl->setOption(CURLOPT_MAXREDIRS, 10);
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-bynder-skudetails-new', $jsonData);
    ...
    public function getDataRemoveForMagento($sku_id, $media_Id, $metaProperty_id)
    {
        ...
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'jpw-sku-data-remove-for-magento');
        $this->_curl->setOption(CURLOPT_RETURNTRANSFER, true);
        $this->_curl->setOption(CURLOPT_TIMEOUT, 0);
        $this->_curl->setOption(CURLOPT_ENCODING, '');
        $this->_curl->setOption(CURLOPT_MAXREDIRS, 10);
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-sku-data-remove-for-magento', $jsonData);
    ...
    public function getAddedCompactviewSkuFromBynder($sku_id, $media_Id, $metaProperty_id)
    {
        ...
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'jpw-added-compactview-sku-from-bynder');
        $this->_curl->setOption(CURLOPT_RETURNTRANSFER, true);
        $this->_curl->setOption(CURLOPT_TIMEOUT, 0);
        $this->_curl->setOption(CURLOPT_ENCODING, '');
        $this->_curl->setOption(CURLOPT_MAXREDIRS, 10);
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-added-compactview-sku-from-bynder', $jsonData);
    ...
    public function getUpdateBynderImageRoleAndAltText($product_sku_key, $metaProperty_Collections, $image)
    {
        ...
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'jpw-update-bynderImageRole-and-altText');
        $this->_curl->setOption(CURLOPT_RETURNTRANSFER, true);
        $this->_curl->setOption(CURLOPT_TIMEOUT, 0);
        $this->_curl->setOption(CURLOPT_ENCODING, '');
        $this->_curl->setOption(CURLOPT_MAXREDIRS, 10);
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-update-bynderImageRole-and-altText', $jsonData);
    ...
    public function changeBynderAssetsDetails($bynder_auth)
    {
        ...
        $jsonData = '{}';
        $fields = json_encode($fields);
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'jpw-sync-assets-details');
        $this->_curl->setOption(CURLOPT_RETURNTRANSFER, true);
        $this->_curl->setOption(CURLOPT_TIMEOUT, 0);
        $this->_curl->setOption(CURLOPT_ENCODING, '');
        $this->_curl->setOption(CURLOPT_MAXREDIRS, 10);
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-sync-assets-details', $jsonData);
    ...
    public function changePopupBynderAssetsDetails($bynder_auth)
    {
        ...
        $jsonData = '{}';
        $fields = json_encode($fields);
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'sync-jpw-popup-assets-details');
        $this->_curl->setOption(CURLOPT_RETURNTRANSFER, true);
        $this->_curl->setOption(CURLOPT_TIMEOUT, 0);
        $this->_curl->setOption(CURLOPT_ENCODING, '');
        $this->_curl->setOption(CURLOPT_MAXREDIRS, 10);
        ...
        $this->_curl->post(self::API_CALLED . 'sync-jpw-popup-assets-details', $jsonData);
    ...
    public function removeSkuOrRoleDAM($bynder_auth)
    {
        ...
        $jsonData = '{}';
        $fields = json_encode($fields);
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'jpw-remove-sku-role-from-dam');
        $this->_curl->setOption(CURLOPT_RETURNTRANSFER, true);
        $this->_curl->setOption(CURLOPT_TIMEOUT, 0);
        $this->_curl->setOption(CURLOPT_ENCODING, '');
        $this->_curl->setOption(CURLOPT_MAXREDIRS, 10);
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-remove-sku-role-from-dam', $jsonData);
    ...
    public function getCheckBynderSideDeleteData($bynder_auth)
    {
        ...
        $jsonData = '{}';
        $fields = json_encode($fields);
        $this->_curl->setOption(CURLOPT_URL, self::API_CALLED . 'jpw-remove-assets-deleted-data-from-dam');
        $this->_curl->setOption(CURLOPT_RETURNTRANSFER, true);
        $this->_curl->setOption(CURLOPT_TIMEOUT, 0);
        $this->_curl->setOption(CURLOPT_ENCODING, '');
        $this->_curl->setOption(CURLOPT_MAXREDIRS, 10);
        ...
        $this->_curl->post(self::API_CALLED . 'jpw-remove-assets-deleted-data-from-dam', $jsonData);
