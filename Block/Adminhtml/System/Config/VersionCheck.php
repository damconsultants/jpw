...
class VersionCheck extends Field
{
    ...
    {
        parent::_construct();
        $this->setTemplate('DamConsultants_JPW::system/config/version_message.phtml');
    }
    ...
    {
        $repoUrl = 'https://api.github.com/repos/damconsultants/jpw/releases/latest';
    ...
    {
        $moduleInfo = $this->moduleList->getOne('DamConsultants_JPW');
    ...
    {
        return 'https://github.com/damconsultants/jpw/releases';
    }
