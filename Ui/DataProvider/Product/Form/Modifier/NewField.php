<?php
namespace DamConsultants\JPW\Ui\DataProvider\Product\Form\Modifier;
                        ...
                        'data' => [
                            'config' => [
                                ...
                                "content" => $this->layoutFactory->create()->createBlock(
                                    \DamConsultants\JPW\Block\Adminhtml\Catalog\Product\Form\Gallery::class
                                )->toHtml(),
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'behaviourType' => 'edit',
                                "content" => $this->layoutFactory->create()->createBlock(
                                    \DamConsultants\JPW\Block\Adminhtml\Catalog\Product\Form\BynderDoc::class
                                )->toHtml(),
                                'externalFilterMode' => true,
                                'currentProductId' => $this->locator->getProduct()->getId(),
                            ],
